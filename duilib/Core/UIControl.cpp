...
namespace DuiLib {
	...
	INT64 CControlUI::GetTagINT64() const
	{
		return m_pTagINT64;
	}

	UINT64 CControlUI::GetTagUINT64() const
	{
		return m_pTagUINT64;
	}

	void CControlUI::SetCache(const std::string& cache) {
		m_Cache = cache;
	}

	const std::string& CControlUI::GetCache() const {
		return m_Cache;
	}

	void CControlUI::SetTagINT64(INT64 pTag)
	{
		m_pTagINT64 = pTag;
	}

	void CControlUI::SetTagUINT64(UINT64 pTag)
	{
		m_pTagUINT64 = pTag;
	}
