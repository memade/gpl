...
PLATFORM=VC-WIN64A
CC=cl
CFLAG= /MD /Ox -DOPENSSL_FIPSCANISTER -DOPENSSL_THREADS  -DDSO_WIN32 -W3 -Gs0 -Gy -nologo -DOPENSSL_SYSNAME_WIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -DUNICODE -D_UNICODE -D_CRT_SECURE_NO_DEPRECATE -DOPENSSL_IA32_SSE2 -DOPENSSL_BN_ASM_MONT -DOPENSSL_BN_ASM_MONT5 -DOPENSSL_BN_ASM_GF2m -DSHA1_ASM -DSHA256_ASM -DSHA512_ASM -DMD5_ASM -DAES_ASM -DWHIRLPOOL_ASM -DGHASH_ASM -DOPENSSL_USE_APPLINK -I. -DOPENSSL_NO_RC5 -DOPENSSL_NO_MD2 -DOPENSSL_NO_KRB5 -DOPENSSL_FIPS -DOPENSSL_NO_JPAKE -DOPENSSL_NO_STATIC_ENGINE  
...
FIPSOBJ=$(OBJ_D)\fips.obj \
	...
	$(OBJ_D)\thr_id.obj $(OBJ_D)\x86_64cpuid.obj $(OBJ_D)\sha1dgst.obj \
	$(OBJ_D)\sha256.obj $(OBJ_D)\sha512.obj $(OBJ_D)\sha1-x86_64.obj \
	$(OBJ_D)\sha256-x86_64.obj $(OBJ_D)\sha512-x86_64.obj $(OBJ_D)\hmac.obj \
	...
	$(OBJ_D)\aes-x86_64.obj $(OBJ_D)\aesni-x86_64.obj $(OBJ_D)\cbc128.obj \
	$(OBJ_D)\ctr128.obj $(OBJ_D)\cfb128.obj $(OBJ_D)\ofb128.obj \
	$(OBJ_D)\gcm128.obj $(OBJ_D)\ccm128.obj $(OBJ_D)\xts128.obj \
	$(OBJ_D)\ghash-x86_64.obj $(OBJ_D)\cmac.obj $(OBJ_D)\bn_add.obj \
	...
	$(OBJ_D)\x86_64-mont5.obj $(OBJ_D)\x86_64-gf2m.obj $(OBJ_D)\bn_recp.obj \
...
$(FIPS_SHA1_EXE): $(OBJ_D)\fips_standalone_sha1.obj $(OBJ_D)\sha1dgst.obj $(TMP_D)\sha1-x86_64.obj $(TMP_D)\sha256-x86_64.obj $(TMP_D)\sha512-x86_64.obj 
  $(LINK) $(LFLAGS) /out:$(FIPS_SHA1_EXE) @<<
	$(OBJ_D)\fips_standalone_sha1.obj $(OBJ_D)\sha1dgst.obj $(TMP_D)\sha1-x86_64.obj $(TMP_D)\sha256-x86_64.obj $(TMP_D)\sha512-x86_64.obj $(EX_LIBS)
<<
	IF EXIST $@.manifest mt -nologo -manifest $@.manifest -outputresource:$@;1
