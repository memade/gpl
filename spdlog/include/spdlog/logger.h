...
typedef std::function<void(const level::level_enum&,const std::chrono::time_point<std::chrono::system_clock>&,const string_view_t&)> tf_msg_cb;
...
public:
	void msgcb(const tf_msg_cb& msgcb) { m_msg_cb = msgcb; }
private:
	tf_msg_cb m_msg_cb = nullptr;
};
